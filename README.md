...
A custom Contentful App that provides JSON Schema validation of JSON Object fields. Unlike standard validators, this app **dynamically fetches the validation schema** from a sibling Reference field, so multiple Schemas can be defined and used throughout different Content Models.
